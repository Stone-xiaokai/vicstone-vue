  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="helpCategory" :rules="rules" ref="helpCategoryFrom" label-width="150px">
      ...
      <el-form-item label="分类图标：" prop="icon">
        <el-input v-model="helpCategory.icon"></el-input>
      </el-form-item>
      <el-form-item label="专题数量：" prop="helpCount">
        <el-input v-model="helpCategory.helpCount"></el-input>
      </el-form-item>
      <el-form-item label="状态：" prop="showStatus">
        <el-input v-model="helpCategory.showStatus"></el-input>
      </el-form-item>
