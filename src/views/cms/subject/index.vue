        ...
        <div class="table-container">
            <el-table ref="subjectTable"
                ...
                <el-table-column label="推荐" align="center">
                    <template slot-scope="scope">{{scope.row.recommendStatus}}</template>
                </el-table-column>
                ...
                <el-table-column label="画册图片" align="center">
                    <template slot-scope="scope">{{scope.row.albumPics}}</template>
                </el-table-column>
...
<script>
    import {fetchList, deleteSubject} from '@/api/cms/subject'
