  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="topicCategory" :rules="rules" ref="topicCategoryFrom" label-width="150px">
      ...
      <el-form-item label="分类图标：" prop="icon">
        <el-input v-model="topicCategory.icon"></el-input>
      </el-form-item>
      <el-form-item label="专题数量：" prop="subjectCount">
        <el-input v-model="topicCategory.subjectCount"></el-input>
      </el-form-item>
      <el-form-item label="状态：" prop="showStatus">
        <el-input v-model="topicCategory.showStatus"></el-input>
      </el-form-item>
      <el-form-item label="排序：" prop="sort">
        <el-input v-model="topicCategory.sort"></el-input>
      </el-form-item>
      <el-form-item>
