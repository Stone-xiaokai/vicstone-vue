<template>
  <div class="app-container">
    ...
    <div class="statistics-layout-city">
      <div class="layout-title">用户地区分布统计</div>
      <div id="myChartCity" :style="{width: '800px', height: '500px'}"></div>
    </div>
  </div>
</template>
<script>
  // import {orderCountreq} from '@/api/home';
  import {getMember,updateMember,orderCountreq,productCountByStatus,productCount,userCount,selectProductCountCate,selectUserCityCount} from '@/api/member';
  export default {
    name: 'home',
    data() {
      return {
    ...
    methods:{
      ...
      async drawLine(){
        ...
        selectUserCityCount().then(response => {
            dataCity=response.data
            var myChart3 = this.$echarts.init(document.getElementById('myChartCity'));
            ...
            var option3 = {
              ...
              series : [
                ...
                // },
                {
                  ...
                  type: 'effectScatter',
                  coordinateSystem: 'geo',
                  data: convertData(dataCity.sort(function (a, b) {
                    return b.values - a.values;
                  }).slice(0, 6)),
                  //   data: [{name: '海门', value: [121.15, 31.89, 90]},
